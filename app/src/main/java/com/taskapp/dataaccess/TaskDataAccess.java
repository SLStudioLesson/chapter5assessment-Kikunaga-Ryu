...
public class TaskDataAccess {
    ...
    public List<Task> findAll() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                int repUsers = Integer.parseInt(values[3]);

                User repUser = userDataAccess.findByCode(repUsers);
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            User repUsers = userDataAccess.findByCode(repUser);

            task = new Task(taskCode, name, status, repUsers);
            break;
        }
    } catch (IOException e) {
    e.printStackTrace();
